...
//        }
        ...
        $game = $app->fetcher->findGameByGroupChatId($chat_id);

        if (!$game) {
            $app->printChat($chat_id, "Utilisez d'abord ". JoinGameCommand::NAME . " pour rejoindre la partie");
            return;
        }
//        if (!$app->checkIsInGroupChat($chat_id)) return;
